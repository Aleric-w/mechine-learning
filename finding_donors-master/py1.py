...
income1= np.array(income_raw.apply(lambda x: int(x=='>50K')))
...
for clf in [clf_B]:
    ...
    for i, samples in enumerate([samples_1, samples_10, samples_100]):
        print ("debug position 1:" , i , samples)
...
clf = SVC()
parameters = {"kernel":['linear','rbf'],"C":np.arange(1,11),"gamma":np.arange(1,21)}
